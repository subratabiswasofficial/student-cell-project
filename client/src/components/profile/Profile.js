                        ...
                        <Grid item>
                            ...
                            <Badge
                                badgeContent={
                                    ...
                                    >
                                        <EditIcon style={{ fontSize: '1.5em', color: theme.palette.common.orange, verticleAlign: 'bottom' }} />
                                    </label>
                                }
                                anchorOrigin={{
                                    vertical: 'bottom',
